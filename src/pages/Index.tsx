        ...
        <section className="bg-foreground text-background">
          <div className="container py-20 text-center">
            ...
            <p className="text-background/70 max-w-md mx-auto mb-8">
              Every piece is selected with intention. Built to last, designed to endure.
            </p>
            <Link
              to="/shop"
              className="inline-block border border-background text-background px-8 py-3 text-sm font-semibold uppercase tracking-widest hover:bg-background hover:text-foreground transition-colors"
            >
              Discover More
            </Link>
          </div>
